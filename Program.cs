...
namespace DSPlus.Examples
{
    public class Program
    {
        ...
        private Task Client_Ready(ReadyEventArgs e)
        {
            ...
            e.Client.DebugLogger.LogMessage(LogLevel.Info, "WolfieCBOT", "Client is ready to process events.", DateTime.Now);
        ...
        private Task Client_GuildAvailable(GuildCreateEventArgs e)
        {
            ...
            // sent to our client
            e.Client.DebugLogger.LogMessage(LogLevel.Info, "WolfieCBOT", $"Guild available: {e.Guild.Name}", DateTime.Now);
        ...
        private Task Client_ClientError(ClientErrorEventArgs e)
        {
            // let's log the name of the guild that was just
            // sent to our client
            e.Client.DebugLogger.LogMessage(LogLevel.Error, "WolfieCBOT", $"Exception occured: {e.Exception.GetType()}: {e.Exception.Message}", DateTime.Now);
        ...
        private Task Commands_CommandExecuted(CommandExecutedEventArgs e)
        {
            // let's log the name of the guild that was just
            // sent to our client
            e.Context.Client.DebugLogger.LogMessage(LogLevel.Info, "WolfieCBOT", $"{e.Context.User.Username} successfully executed '{e.Command.QualifiedName}'", DateTime.Now);
        ...
        private async Task Commands_CommandErrored(CommandErrorEventArgs e)
        {
            // let's log the name of the guild that was just
            // sent to our client
            e.Context.Client.DebugLogger.LogMessage(LogLevel.Error, "WolfieCBOT", $"{e.Context.User.Username} tried executing '{e.Command?.QualifiedName ?? "<unknown command>"}' but it errored: {e.Exception.GetType()}: {e.Exception.Message ?? "<no message>"}", DateTime.Now);
